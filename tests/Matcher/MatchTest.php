...
class MatchTest extends TestCase
{
    ...
    {
        $match = new UrlMatch('http://example.com', 0, 'http://example.com', null, null, null, null, null, null);
        $result = $match->getUrl();
    ...
    {
        $match = new UrlMatch('', 29, '', null, null, null, null, null, null);
    ...
    {
        $match = new UrlMatch('http://example.com?a=1&amp;b=2', 0, 'http://example.com?a=1&b=2', null, null, null, null, null, null);
        $result = $match->getUrl();
    ...
    {
        $match = new UrlMatch('', 0, '', 'http', null, null, null, null, null);
    ...
    {
        $match = new UrlMatch('', 0, '', null, 'user:password', null, null, null, null);
    ...
    {
        $match = new UrlMatch('', 0, '', null, null, 'example.com', null, null, null);
    ...
    {
        $match = new UrlMatch('', 0, '', null, null, null, 'com', null, null);
        $result = $match->getTld();
    ...
    {
        $match = new UrlMatch('', 0, '', null, null, null, null, '80', null);
    ...
    {
        $match = new UrlMatch('', 0, '', null, null, null, null, null, 'path/to/page.html');
