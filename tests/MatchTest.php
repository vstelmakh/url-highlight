...
class MatchTest extends TestCase
{
    ...
    {
        $match = new Match('http://example.com', null, null, null, null);
    ...
    {
        $match = new Match('', 'http', null, null, null);
    ...
    {
        $match = new Match('', null, 'user:password', null, null);
    ...
    {
        $match = new Match('', null, null, 'example.com', null);
    ...
    {
        $match = new Match('', null, null, null, 'com');
        $result = $match->getTld();
