...
class ValidatorTest extends TestCase
{
    ...
    public function isValidMatchDataProvider(): array
    {
        return [
            ...
            [true, [], [], true, $this->getMatch('http', null, null, null), false],
            ...
            [true, [], [], true, $this->getMatch('http', null, 'filename.txt', 'txt'), false],
            ...
            [true, ['ftp'], ['http'], true, $this->getMatch('http', null, null, null), false],
            [true, ['ftp'], ['ssh'], true, $this->getMatch('http', null, null, null), false],
            [true, ['ftp'], ['http'], true, $this->getMatch(null, null, 'example.com', 'com'), true],

            [false, [], [], true, $this->getMatch(null, null, null, null), true],
            [false, [], [], true, $this->getMatch('http', null, null, null), true],
            [false, [], [], true, $this->getMatch(null, null, 'example.com', 'com'), true],
            [false, [], [], true, $this->getMatch(null, null, 'filename.txt', 'txt'), true],
            ...
            [false, ['http'], [], true, $this->getMatch(null, null, 'example.com', 'com'), true],
            ...
            [false, ['ftp'], ['http'], true, $this->getMatch(null, null, 'example.com', 'com'), true],
